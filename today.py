...
USER_NAME = os.environ['USER_NAME'] # 'yusuf7264'
...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    root = tree.getroot()
    # Length constants are tuned for the 70-column info panel in the SVGs.
    # Rows containing an unpadded field (contrib_data, loc_add) shift slightly
    # with the digit count of that field, as they do upstream.
    ...
    justify_format(root, 'loc_del', loc_data[1], 14)
...
if __name__ == '__main__':
    """
    Yusuf Hassan (yusuf7264), 2026
    Based on the profile README generator by Andrew Grant (Andrew6rant), 2022-2025
    https://github.com/Andrew6rant/Andrew6rant
    """
    print('Calculation times:')
    # define global variable for owner ID and calculate user's creation date
    # e.g {'id': 'MDQ6VXNlcjEyMzQ1Njc4'} and 2021-04-17T09:02:44Z
